...
// them 100% and drops the body margin/scrollbar; the FluentProvider height is set in main.tsx and the
// shell below fills the rest. (griffel over hand-rolled CSS — `.claude/rules/frontend-architecture.md`.)
